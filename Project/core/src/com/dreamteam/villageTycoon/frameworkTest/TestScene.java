...
public class TestScene extends Scene {
	...
	public TestScene() {
		...
		for(int i = 0; i < 1; i++) {
			addObject(new Soldier(playerCity, new Vector2(2, 2), new WeaponType("pistol", 1, 1, 1, 1, 1, new ProjectileType(ProjectileType.Type.SHOT, 1, 1, "soldier"), new Sprite(AssetManager.getTexture("gun")), Type.HANDGUN), 
