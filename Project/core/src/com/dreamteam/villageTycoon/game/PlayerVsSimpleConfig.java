...
public class PlayerVsSimpleConfig implements PlayerConfig {
	public City[] getCities(Scene scene) {
		City playerCity = new City(scene, "you", new PlayerController(), new Vector2(3, 3));
		
		City aiCity1 = new City(scene, "AIController3 aka simple AI", new AIController3(playerCity), new Vector2(5, 3));
